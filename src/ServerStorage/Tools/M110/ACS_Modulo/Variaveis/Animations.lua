...
local module = {
	...
	SprintAnim = function(char, speed, objs)
		ts:Create(objs[2],TweenInfo.new(0.3),{C1 = CFrame.new(-0.56, -0.4, -1) * CFrame.Angles(math.rad(-70), math.rad(-38), math.rad(0))}):Play();
		ts:Create(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(0.75, 0.71, -1) * CFrame.Angles(math.rad(270), math.rad(-18), math.rad(-25))}):Play();
		wait(0.3)
	end;
