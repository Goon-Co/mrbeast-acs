...
local module = {
	...
	GLReadyAnim = function(char, speed, objs)
		ts:Create(objs[2],TweenInfo.new(0.5),{C1 = CFrame.new(-0.875, 0, -1.15) * CFrame.Angles(math.rad(-95), math.rad(-2), math.rad(7.5))}):Play()
		ts:Create(objs[3],TweenInfo.new(0.5),{C1 = CFrame.new(0.6,0.3,-1.8) * CFrame.Angles(math.rad(-130),math.rad(30),math.rad(0))}):Play()
		wait(0.4)
		
		ts:Create(objs[5].Lid2:WaitForChild("Lid2"),TweenInfo.new(0.5),{C1 = CFrame.new(0.0,0.0,0.0) * CFrame.Angles(math.rad(55),math.rad(0),math.rad(0))}):Play()
		ts:Create(objs[3],TweenInfo.new(0.5),{C1 = CFrame.new(0.8,-0.5,-2) * CFrame.Angles(math.rad(-160),math.rad(30),math.rad(0))}):Play()
		objs[5].Handle:WaitForChild("M203_Sight"):Play()
		wait(0.4)
		ts:Create(objs[2],TweenInfo.new(0.4),{C1 = require(script.Parent.Settings).RightPos}):Play() -- require(script).FakeRightPos (For fake arms) | require(script).RightArmPos (For real arms)
		ts:Create(objs[3],TweenInfo.new(0.4),{C1 = require(script.Parent.Settings).LeftPos}):Play() -- require(script).FakeLeftPos (For fake arms) | require(script).LeftArmPos (For real arms)	
		wait(0.1)
	end;

	GLUnReadyAnim = function(char, speed, objs)
		ts:Create(objs[2],TweenInfo.new(0.5),{C1 = CFrame.new(-0.875, 0, -1.15) * CFrame.Angles(math.rad(-95), math.rad(-2), math.rad(7.5))}):Play()
		ts:Create(objs[3],TweenInfo.new(0.5),{C1 = CFrame.new(0.8,-0.5,-2) * CFrame.Angles(math.rad(-160),math.rad(30),math.rad(0))}):Play()
		wait(0.4)
		ts:Create(objs[5].Lid2:WaitForChild("Lid2"),TweenInfo.new(0.5),{C1 = CFrame.new(0.0,0.0,0.0) * CFrame.Angles(math.rad(0),math.rad(0),math.rad(0))}):Play()
		ts:Create(objs[3],TweenInfo.new(0.5),{C1 = CFrame.new(0.6,0.3,-1.8) * CFrame.Angles(math.rad(-130),math.rad(30),math.rad(0))}):Play()
		objs[5].Handle:WaitForChild("M203_Sight"):Play()
		wait(0.4)
		ts:Create(objs[2],TweenInfo.new(0.4),{C1 = require(script.Parent.Settings).RightPos}):Play() -- require(script).FakeRightPos (For fake arms) | require(script).RightArmPos (For real arms)
	...
	GLReloadAnim = function(char, speed, objs)
		ts:Create(objs[2],TweenInfo.new(0.6),{C1 = CFrame.new(-1.3, -1.5, -1.7) * CFrame.Angles(math.rad(-140), math.rad(-10), math.rad(0))}):Play()
		ts:Create(objs[3],TweenInfo.new(0.6),{C1 = CFrame.new(0.8,-0.5,-2) * CFrame.Angles(math.rad(-160),math.rad(40),math.rad(10))}):Play()
		wait(.4)--(.3)
		if objs[12].Value then
			objs[5].M203Shell.Transparency = 0
		else
			objs[5].M203Shell.Transparency = 1
		end
		ts:Create(objs[5].m203tube:WaitForChild("m203tube"),TweenInfo.new(0.4),{C1 = CFrame.new(0.0,0.0,-0.6) * CFrame.Angles(math.rad(0),math.rad(0),math.rad(0))}):Play()
		ts:Create(objs[5].M203Shell:WaitForChild("M203Shell"),TweenInfo.new(0.4),{C1 = CFrame.new(0.0,0.0,-0.5) * CFrame.Angles(math.rad(0),math.rad(0),math.rad(0))}):Play()
		ts:Create(objs[3],TweenInfo.new(0.45),{C1 = CFrame.new(1.2,-0.1,-2) * CFrame.Angles(math.rad(-160),math.rad(40),math.rad(10))}):Play()
		objs[5].Handle:WaitForChild("M203_Open"):Play()
		wait(.4)--(.5)
		
		local MagS = objs[5]:WaitForChild("M203Shell"):clone()
		MagS.Parent = objs[5]
		MagS.Name = "MagS"
		if objs[12].Value then
			MagS.Transparency = 0
		...
		local MagSW = Instance.new("Motor6D")
		MagSW.Part0 = MagS
		MagSW.Part1 = objs[3].Parent.Parent:WaitForChild("Left Arm")
		MagSW.Parent = MagS
		MagSW.C1 = MagS.CFrame:toObjectSpace(objs[3].Parent.Parent:WaitForChild("Left Arm").CFrame)
		ts:Create(MagSW,TweenInfo.new(0),{C0 = CFrame.new(0.7, 0, -0.8) * CFrame.Angles(math.rad(-90), math.rad(0), math.rad(-51))}):Play()
		ts:Create(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(0.8,-0.5,-2) * CFrame.Angles(math.rad(-160),math.rad(40),math.rad(10))}):Play()
		wait(.3)
		...
		--m203 insert
		objs[5].Handle:WaitForChild("M203_Insert"):Play()
		ts:Create(objs[3],TweenInfo.new(0.6),{C1 = CFrame.new(0.8,-0.5,-2) * CFrame.Angles(math.rad(-160),math.rad(40),math.rad(10))}):Play()
		wait(.5)
		
		
		-- NEED TO PUSH GRENADE INTO TUBE, THEN SLIDE BACK
		ts:Create(objs[3],TweenInfo.new(.3),{C1 = CFrame.new(1.1,-0.1,-2) * CFrame.Angles(math.rad(-160),math.rad(40),math.rad(10))}):Play()
		wait(.3)
		MagS:Destroy()
		objs[5].M203Shell.Transparency = 0
		wait(.3)
		
		ts:Create(objs[3],TweenInfo.new(0.25),{C1 = CFrame.new(1.2,-0.1,-2) * CFrame.Angles(math.rad(-160),math.rad(40),math.rad(10))}):Play()
		wait(.3)
		
		ts:Create(objs[5].m203tube:WaitForChild("m203tube"),TweenInfo.new(0.3),{C1 = CFrame.new(0.0,0.0,-0) * CFrame.Angles(math.rad(0),math.rad(0),math.rad(0))}):Play()
		ts:Create(objs[3],TweenInfo.new(0.35),{C1 = CFrame.new(0.8,-0.5,-2) * CFrame.Angles(math.rad(-160),math.rad(40),math.rad(10))}):Play()
		wait(.4)--(.3)
		ts:Create(objs[2],TweenInfo.new(0.85),{C1 = require(script.Parent.Settings).RightPos}):Play() -- require(script).FakeRightPos (For fake arms) | require(script).RightArmPos (For real arms)
		ts:Create(objs[3],TweenInfo.new(0.85),{C1 = require(script.Parent.Settings).LeftPos}):Play() -- require(script).FakeLeftPos (For fake arms) | require(script).LeftArmPos (For real arms)	
